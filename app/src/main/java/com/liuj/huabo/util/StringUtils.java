...
public class StringUtils {
    ...
    public static String stripAccents(final String input) {
        ...
        return pattern.matcher(decomposed).replaceAll(com.liuj.huabo.util.StringUtils.EMPTY);
    }
    ...
    public static String removeAll(final String text, final String regex) {
        return replaceAll(text, regex, com.liuj.huabo.util.StringUtils.EMPTY);
    }
    ...
    public static String removeFirst(final String text, final String regex) {
        return replaceFirst(text, regex, com.liuj.huabo.util.StringUtils.EMPTY);
    }
    ...
    public static String removePattern(final String source, final String regex) {
        return replacePattern(source, regex, com.liuj.huabo.util.StringUtils.EMPTY);
    }
   ...
   public static String replaceIgnoreCase(final String text, final String searchString, final String replacement) {
     ...
     * @deprecated This feature will be removed in Lang 4.0, use {@link com.liuj.huabo.util.StringUtils#removeEnd(String, String)} instead
     */
    @Deprecated
    ...
    public static String swapCase(final String str) {
        if (com.liuj.huabo.util.StringUtils.isEmpty(str)) {
            return str;
        }
     ...
     * @see com.liuj.huabo.util.StringUtils#defaultString(String, String)
     */
     ...
     * @see com.liuj.huabo.util.StringUtils#startsWith(CharSequence, CharSequence)
     ...
     * @see com.liuj.huabo.util.StringUtils#endsWith(CharSequence, CharSequence)
     * @return {@code true} if the input {@code sequence} is {@code null} AND no {@code searchStrings} are provided, or
     ...
     * @deprecated use {@link com.liuj.huabo.util.StringUtils#toEncodedString(byte[], Charset)} instead of String constants in your code
     * @since 3.1
     */
    @Deprecated
