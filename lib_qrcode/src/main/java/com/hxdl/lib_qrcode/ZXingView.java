...
import com.hxdl.lib_qrcode.core.BGAQRCodeUtil;
import com.hxdl.lib_qrcode.core.BarcodeType;
import com.hxdl.lib_qrcode.core.QRCodeView;
import com.hxdl.lib_qrcode.core.ScanResult;
...
public class ZXingView extends QRCodeView {
    ...
    private boolean mScanInvert = false; //是否做反色处理
    ...
    protected ScanResult processData(byte[] data, int width, int height, boolean isRetry) {
        ...
        try {
            ...
            Log.d("processData","source");
            if(false){//!mScanInvert) {
                mScanInvert = true;
