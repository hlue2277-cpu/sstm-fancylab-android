package com.hxdl.lib_qrcode.test;
...
import com.hxdl.lib_qrcode.R;
import com.hxdl.lib_qrcode.ZXingView;
import com.hxdl.lib_qrcode.core.QRCodeView;
...
public class QrCodeScanActivity extends AppCompatActivity implements QRCodeView.Delegate {
    ...
    public TextView mTvManual , mTvDataSync;

    public TextView mTvPaperTicket;
    public TextView mTvIDCard;
    public TextView mTvIDFace;
    public TextView mSwitchScan;

    public RelativeLayout mRlIDCard;

    public int currentMode = 0;// 纸质票   身份证
    //当前扫描模式
    public boolean currentScanFlag = false; //false-- camera mode   true --hongwai mode

    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_test_scan);
        mZXingView = findViewById(R.id.zxingview);
        mTvManual = findViewById(R.id.tv_manual_input);
        mTvDataSync = findViewById(R.id.tvDataSync);
        ...
        mTvPaperTicket = findViewById(R.id.tv_paper_ticket);
        mTvIDCard = findViewById(R.id.tv_id_card);
        mRlIDCard = findViewById(R.id.rl_id_card);
        mTvIDFace = findViewById(R.id.tv_id_face);
        mSwitchScan = findViewById(R.id.switch_scan);
    }
    ...
    protected void onResume() {
        super.onResume();
        if(currentMode == 0 && !currentScanFlag) {
            mZXingView.startCamera(); // 打开后置摄像头开始预览，但是并未开始识别
//        mZXingView.startCamera(Camera.CameraInfo.CAMERA_FACING_FRONT); // 打开前置摄像头开始预览，但是并未开始识别
//        mZXingView.setEffectNegative();
